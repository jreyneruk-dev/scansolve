...
function posterHTML(name: string, uid: string, qr: string, isLast: boolean): string {
  ...
  return `<div style="width:210mm;height:297mm;${brk}box-sizing:border-box;background:white;display:flex;flex-direction:column;align-items:center;padding:24mm;font-family:system-ui,-apple-system,sans-serif;overflow:hidden;">
    <div style="display:flex;align-items:center;gap:6mm;">
      ${logoSvgMarkup(39)}
      <span style="font-size:40pt;font-weight:700;color:#1e293b;letter-spacing:-0.02em;">ScanSolve</span>
    </div>
    <div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:11mm;width:100%;">
      <div style="font-size:26pt;line-height:1.15;font-weight:800;color:#0f172a;text-align:center;white-space:nowrap;">See something that needs fixing?</div>
      <div style="padding:9mm;border:0.4mm solid #e2e8f0;border-radius:6mm;display:flex;flex-direction:column;align-items:center;gap:5mm;">
        <img src="${qr}" alt="QR code" style="width:78mm;height:78mm;display:block;" />
        <div style="font-size:9pt;color:#94a3b8;font-family:'Courier New',monospace;letter-spacing:0.04em;">${esc(uid)}</div>
      </div>
      <div style="font-size:19.5pt;line-height:1.5;color:#334155;text-align:center;max-width:150mm;">
        <div>Scan the code with your phone camera and tell us.</div>
        <div>No app, no login — about 20 seconds, and we'll get it sorted.</div>
      </div>
